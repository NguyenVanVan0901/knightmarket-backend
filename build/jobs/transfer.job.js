...
class JobScanKnightMarket {
    constructor() {
        ...
        this.cronJob = new cron_1.CronJob("*/12 * * * * *", () => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                for (let i = 0; i < eventLogs.length; i++) {
                    ...
                    NewKnight.image = (_a = data === null || data === void 0 ? void 0 : data.image) === null || _a === void 0 ? void 0 : _a.replace("ipfs://", "https://ipfs.io/ipfs/");
